...
Module Info.
  ...
  Definition source_file := "clightplus_examples/xorlist/src/main.c".
...
(Ssequence
  (Ssequence
    (Sassign (Evar _head (tptr (Tstruct __Node noattr)))
      ...
      (Ssequence
        ...
        (Ssequence
          (Scall None
            ...
            ((Eaddrof (Evar _head (tptr (Tstruct __Node noattr)))
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_add_hd,
   Gfun(External (EF_external "add_hd"
                   (mksignature (AST.Tlong :: AST.Tlong :: AST.Tlong :: nil)
                     AST.Tvoid cc_default))
     (Tcons (tptr (tptr (Tstruct __Node noattr)))
       (Tcons (tptr (tptr (Tstruct __Node noattr))) (Tcons tlong Tnil)))
     tvoid cc_default)) ::
 (_add_tl,
   Gfun(External (EF_external "add_tl"
                   (mksignature (AST.Tlong :: AST.Tlong :: AST.Tlong :: nil)
                     AST.Tvoid cc_default))
     (Tcons (tptr (tptr (Tstruct __Node noattr)))
       (Tcons (tptr (tptr (Tstruct __Node noattr))) (Tcons tlong Tnil)))
     tvoid cc_default)) ::
 (_delete_hd,
   Gfun(External (EF_external "delete_hd"
                   (mksignature (AST.Tlong :: AST.Tlong :: nil) AST.Tlong
                     cc_default))
     (Tcons (tptr (tptr (Tstruct __Node noattr)))
       (Tcons (tptr (tptr (Tstruct __Node noattr))) Tnil)) tlong cc_default)) ::
 (_delete_tl,
   Gfun(External (EF_external "delete_tl"
                   (mksignature (AST.Tlong :: AST.Tlong :: nil) AST.Tlong
                     cc_default))
     (Tcons (tptr (tptr (Tstruct __Node noattr)))
       (Tcons (tptr (tptr (Tstruct __Node noattr))) Tnil)) tlong cc_default)) ::
...
(_main :: _delete_tl :: _delete_hd :: _add_tl :: _add_hd ::
