...
Module Info.
  ...
  Definition source_file := "hardening.c".
...
Definition f_encode := {|
  ...
  fn_params := ((_key, tulong) :: (_ptr, (tptr tvoid)) :: nil);
  fn_vars := nil;
  fn_temps := ((_encoded, tulong) :: (_t'1, (tptr tvoid)) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    ...
    (Sset _encoded
      (Ebinop Oxor (Etempvar _t'1 tulong) (Etempvar _key tulong) tulong)))
  (Sreturn (Some (Etempvar _encoded tulong))))
|}.
...
Definition f_decode := {|
  ...
  fn_vars := nil;
  fn_temps := ((_decoded, (tptr tvoid)) :: nil);
  fn_body :=
(Ssequence
  (Sset _decoded
